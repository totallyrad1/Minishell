NAME= minishell
SOURCES= ./parsing/tree.c ./builtins/cd.c ./builtins/echo.c ./builtins/env.c ./builtins/export.c ./builtins/get_home_dir.c ./builtins/pwd.c ./builtins/unset.c ./minishell.c ./parsing/parsing.c ./pipe.c ./signals/handle_signals.c ./syntaxerror.c ./utils/free_array.c ./utils/ft_is.c ./utils/ft_split.c ./utils/ft_strdup.c ./utils/ft_strjoin.c ./utils/ft_strlcpy.c ./utils/ft_strlen.c ./utils/ft_strncmp.c ./utils/ft_strtrim.c ./utils/ft_substr.c ./utils/tools.c ./utils/clone_env.c ./utils/tree_utils.c ./utils/tree_utils2.c
OBJECT= $(SOURCES:.c=.o)
CC = cc 
