NAME= minishell
SOURCES= builtins/cd.c builtins/echo.c builtins/exit.c builtins/export.c builtins/get_points.c builtins/print_env.c builtins/pwd.c builtins/unset.c env/add_env.c env/arr_to_env.c env/change_value.c env/del_node.c env/env_to_arr.c env/get_env_null.c env/get_node.c env/get_value.c env/key_exist.c env/make_env.c execution/here_doc.c execution/join_args.c execution/join_args1.c execution/join_args2.c execution/join_redir.c execution/onecommand.c execution/onecommandexec.c execution/pipeexecution.c execution/squote_or_dquote.c garbage_collector/rad_gc.c parsing/parsing.c parsing/tree.c signals/handle_signals.c utils/array_len.c utils/cmd_utils.c utils/fd_utils.c utils/free_array.c utils/ft_is.c utils/ft_is1.c utils/ft_isalpha.c utils/ft_itoa.c utils/ft_putstr.c utils/ft_split.c utils/ft_strchr.c utils/ft_strdup.c utils/ft_strjoin.c utils/ft_strlcpy.c utils/ft_strlen.c utils/ft_strncmp.c utils/ft_strtrim.c utils/ft_substr.c utils/recursive_parsing.c utils/recursive_parsing1.c utils/tools.c utils/tree_utils.c utils/tree_utils2.c wildcard/get_dirent.c wildcard/lst_utils.c wildcard/wildcard.c wildcard/wildcard_utils.c expand.c minishell.c pipe.c syntaxerror.c
OBJECT= $(SOURCES:.c=.o)
CC = cc
